# Calibration-and-Analysis-of-Instrumentation-AmplifierCalibration and Analysis of Instrumentation Amplifier
...
Procedure:
1.	To apply input signal from various sources to the biosignal amplifier and observe the output 
2.	of biosignal amplifier.
3.	To change the gain of Amplifier and observe the change in output signal.
4.	To record the output of biosignal amplifier with different gains and different inputs.
5.	Plot the characteristic of biosignal amplifier.
6.	To compare the output of simulated biosignal amplifier with the theoritical value.
    
Simulation of DC:
<img width="920" height="372" alt="image" src="https://github.com/user-attachments/assets/7c88c22e-3947-427e-9762-69d028172547" />

<img width="920" height="363" alt="image" src="https://github.com/user-attachments/assets/bc9f3df9-e8c5-4210-a254-c2c5d64ad015" />


Simulation of AC:
<img width="941" height="382" alt="image" src="https://github.com/user-attachments/assets/46bf0e83-3d4f-4960-95fd-093694e24422" />

<img width="919" height="374" alt="image" src="https://github.com/user-attachments/assets/96bebece-567c-43ba-8284-2285714e2c7a" />
...
Result:
           Calibration and Analysis of Instrumentation Amplifier Stimulated and Verified.
